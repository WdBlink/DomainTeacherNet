...
def sliding_window(img, model, augment, visualize, kernal_size=1000):
    fold = torch.nn.Unfold(kernel_size=kernal_size, dilation=1, stride=kernal_size)
    cropped_images = fold(img)
